...
for idx, fname in enumerate(images):
	...
	write_name = './test_images/undistort'+str(idx+1)+'.jpg'
	...
	#write_name = './test_images/preprocessImage'+str(idx+1)+'.jpg'
	...
	write_name = './test_images/try'+str(idx+1)+'.jpg'
	cv2.imwrite(write_name, warped_color)
	...
	write_name = './test_images/box'+str(idx+1)+'.jpg'
	...
	final_line = cv2.addWeighted(base, 1.0, road_warped, 1.0, 0.0)
	...
	write_name = './test_images/two_lines'+str(idx+1)+'.jpg'
	cv2.imwrite(write_name, final_line)	
